...
class ViewDemoViewController: UIViewController {
  ...
  let str2 = "很遗憾，您的视频认证审点击认证核未通过，请拍摄真是清晰的个人近照。<a href=\"video_certification\">点击认证</a>"
  ...
  func setupUI() {
    ...
    let interpreters: [Interpreter] = [htmlInterpreter, pictureInterpreter, clickableInterpreter]
