...
class ViewDemoViewController: UIViewController {
  ...
  let str = "3040万像素 细节更扎实控噪有惊喜佳能5D4大家最直观的感受就是采[timg-4][timg-4]用了3040万像素的全新传感器，全新传感器相于5D3提升了大约800万像[timg-4][timg-4][timg-4][timg-4][timg-4]，但是借助于DIGIC 6+处理器，佳能5D4在控噪上<a>粉丝及开发</a>并不弱于5D3，在如此大的像素提升下，控噪不退步，就已经是很大的提升。另外，全新的传感器成像细节表现非常不错，成像相当扎实。（点击直达相关测试）·宽容度大突破 这一次真的有感动大家对于佳能以往机器，最大的诟病莫过于宽容度问题，佳能5D3算得上是台好机子，但是宽容度绝对不算在优点之内，如今佳能也已经[timg-4]采用了片上ADC，宽容[timg-4]度问题在根源上已经<a>粉丝及开发</a>解决了"
...
//    textStyle.textAlignment = .center
    ...
    let size = WZRichTextView.calculateSize(with: testStr, with: textStyle, with: interpreters, with: view.frame.width - 40)
