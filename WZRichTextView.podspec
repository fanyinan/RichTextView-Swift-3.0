...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/fanyinan/RichTextView-Swift-3.0"
  ...
  s.source       = { :git => "https://github.com/fanyinan/RichTextView-Swift-3.0", :tag => s.version.to_s }
