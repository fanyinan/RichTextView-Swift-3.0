...
class ViewController2: UIViewController {
  ...
  func setupUI() {
    ...
    clickableInterpreter.keyTextNormalForegroundColor = UIColor.white
    ...
    let richTextView = WZRichTextView(frame: CGRect(x: 0, y: 0, width: view.frame.width, height: view.frame.height))
